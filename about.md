...
<div class="prose">
  ...
  <p>
    ...
    to see my research and professional work instead, head over to my
    {% if site.portfolio_url %}<a href="{{ site.portfolio_url }}" target="_blank" rel="noopener">portfolio</a>{% else %}portfolio{% endif %}.
  </p>
  <p>
    Say hello: <a href="mailto:Jyotismita.Adhikary@ncbj.gov.pl">Jyotismita.Adhikary@ncbj.gov.pl</a>
  </p>
</div>
